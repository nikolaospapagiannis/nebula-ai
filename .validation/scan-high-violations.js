...
console.log('Scanning for high-violation files (3+ violations)...\n');
...
console.log(`Found ${highViolationFiles.length} files with 3+ violations:\n`);
...
// Save results
fs.writeFileSync(
  'E:/ExAI-GOD/high-violations-scan.json',
  JSON.stringify(highViolationFiles, null, 2)
);

console.log('\n\nResults saved to: high-violations-scan.json');
